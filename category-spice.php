        ...
        <section class="main-panel">
            <div class="center-box">
                <figure class="section-banner">
                    <img class="img" src="<?php echo get_template_directory_uri() ?>/assets/img/spice.png">
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="category-list column3">
                            <li><a href="../seiwa-special-curry" class="btn">星和特製カレー</a></li>
                            <li><a href="../spice-mix-seasoning" class="btn btn-multiline">スパイスミックス・<br>シーズニング</a></li>
                            <li><a href="../various-spices" class="btn">各種香辛料</a></li>
                        </ul>
                    </dd>
                    <dd>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <ul class="sub-category">
                                            <li><a href="../seiwa-special-curry"><span>星和特製カレー</span></a></li>
                                            <li><a href="../spice-mix-seasoning"><span>スパイスミックス・シーズニング</span></a></li>
                                            <li><a href="../various-spices"><span>各種香辛料</span></a></li>
                                        </ul>
                                    </dd>
                                </dl>
                            </li>
